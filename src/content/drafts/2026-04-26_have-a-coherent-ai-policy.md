...
Before I started, a new executive had been brought in and one of her jobs was to streamline process. Her plan was simple. She was going to start by standing behind employees with a stopwatch and time out how long it took them to complete tasks. Then KPIs would be setup based on those meaurements.
...
TODO: Put in a ton of links into the above paragraph.
...
But what I am confident of is that the current generation of LLMs is causing the biggest upheaval in software engineering in my almost twenty year career. And as the manager of a team, it's part of of my job to have some position on that. So, after much discussion with the team, I quickly put together a guide describing our AI philosophy.

Since putting this together, I have been shocked to talk to many developers at companies that have no such document. The mandate is simply to AI as hard as possible and hope it all works.
...
AI in its current form is far too leaky of an abstraction for these details to not constantly bubble yo in any codebase or domain of reasonable complexity. Until that changes, juniors must learn and learning happens by doing.
...
> 
> This is relevant in our AI world. It can be tempting to ship as much as AI-generated code as possible to make out customers happier. This cannot come at the expense of AI-slop in our codebase though. It hurts long-term productivity and happiness of the team. Engineers do not want to spend all day reviewing AI-slop PRs.
